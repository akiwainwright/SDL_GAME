...
VehicleAgent::VehicleAgent(class Game* _game, string _name, ActorState _state, Actor* _parent, SteeringVehicleParameter* _vehicleParams) : GameObject(_game, _name, _state, _parent)
{
